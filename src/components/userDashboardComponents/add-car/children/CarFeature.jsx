...
const CarFeature = () => {
  const {
    ...
    roof_box,
    usb,
  } = useSelector((_) => _.features);

  const { _18_plus, smoking_allowed, outside_accra, deliver_car } = useSelector(
    (_) => _.rental_condition
  );
  const feature_list = [
    {
  ...
  return (
    <div className="">
      <h4 className="mb-4 text-[1.35rem]">Feature list</h4>
      ...
      <h4 className="mb-4 mt-[30px] text-[1.35rem]">Rental Conditions</h4>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
